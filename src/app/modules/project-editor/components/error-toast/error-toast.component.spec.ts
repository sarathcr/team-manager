...
describe('ErrorToastComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: ProjectEditorToastService, useClass: ProjectEditorToastServiceStub }
      ],
    })
  ...
  it('should contain error message and status', () => {
    ...
    fixture.detectChanges()
    const errorElement = fixture.debugElement.query(By.css('.error-toast')).nativeElement
